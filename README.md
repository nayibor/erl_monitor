...
and forwards it to a websocket server for distrubition to user browsers whom are authorized to view those messages .
...
a release is being worked on and will be done soon with instructions for installation 
